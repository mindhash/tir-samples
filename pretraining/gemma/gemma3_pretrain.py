...
# You can get the latest script from Nemo (2.6.0) >> Scripts  >> pretrain_gemma.py
...
from nemo.collections.llm.gpt.model.gemma3 import Gemma3Config4B, Gemma3Model
...
def main():
    ...
    logger = nl.NeMoLogger(
        explicit_log_dir="/pfs/pretraining/nemo_logs/",
    ...
    resume = nl.AutoResume(
        ...
        restore_config=nl.RestoreConfig(path="/pfs/nemo_hub/nemo/models/google/gemma-3-4b-pt/"), 
